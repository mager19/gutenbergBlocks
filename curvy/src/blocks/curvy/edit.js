...
export default function Edit(props) {
	const { className, ...blocksProps } = useBlockProps();

	return (
		<>
			<section className={`${className} alignfull`} {...blocksProps}>
				{props.attributes.enableTopCurve &&
					<Curve
						flipX={props.attributes.topFlipX ?? false}
						flipY={props.attributes.topFlipY ?? false}
				...
				{props.attributes.enableBottomCurve &&
					<Curve
						isBottom
						flipX={props.attributes.bottomFlipX ?? false}
						flipY={props.attributes.bottomFlipY ?? false}
